...
| Conversations                 | Direct messages, unread state, and compact chat exist                                                                                                                                                        | Shared store, cursor pagination, atomic send/read operations, private realtime, blocking, rate limits, and reliability tests remain                         |
...
| Learning and knowledge        | Academy, courses, lessons, quizzes, Skills, Loop, and SODA exist with seed content                                                                                                                           | Server-side quiz grading, storage, editorial provenance, outage truth, canonical metadata, and learner analytics remain                                     |
...
- introduce atomic send/read RPCs with validated length, participant/connection/block checks, notification creation, idempotency, and safe audit metadata;
...
### W8. Academy, Skills, Loop, SODA, and knowledge integrity
...
- define canonical ownership, evidence, effective date, version, and moderation for Skills, Loop, and SODA content;
...
- unify queues for access requests, verification, reports, vouches, content, roles, education, SODA, Skills, Loop, missions, chapters, events, and stories;
