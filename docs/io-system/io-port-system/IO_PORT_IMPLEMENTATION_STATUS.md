...
| Hosted migrations/functions            | Released        | `io-gateway` v26, `io-openai` v8 and `io-provider-conformance` v3 enforce their custom authentication and browser-origin boundaries.                                      |
