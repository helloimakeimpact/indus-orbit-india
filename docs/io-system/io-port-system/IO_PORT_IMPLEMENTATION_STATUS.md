...
| Hosted migrations/functions            | Released        | `io-gateway` v28, `io-openai` v10, `io-provider-conformance` v3 and `io-health-probe` v1 enforce their custom authentication and browser-origin/service-only boundaries.                                                                                                                                                                                                  |
