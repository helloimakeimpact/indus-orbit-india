...
| `npm run test:unit`                    | Pass — 54/54    | Auth/product/location, conversations, OpenCode cancellation/bounds, gateway operations/adapters/routing and fixed email templates are covered. |
