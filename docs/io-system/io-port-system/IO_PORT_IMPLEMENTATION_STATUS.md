...
| Audit                     | Deployed migration defines immutable receipts and per-provider attempts; local provider/ACL/schema pgTAP now passes | No live route has produced one; policy/health/budget snapshots remain incomplete                                             | Deploy the SQL contracts, then verify a bounded conformance receipt and reconcile with the eventual ledger |
