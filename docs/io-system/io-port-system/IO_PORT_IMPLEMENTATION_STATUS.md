...
| `npm run test:unit`                    | Pass — 71/71    | Auth/product/location, conversations/Orbit feed, packaged OpenCode capability/SSE/tasks/diffs/tools/fork/abort/revert/permissions, gateway protocols/adapters/routing and fixed email templates are covered. |
