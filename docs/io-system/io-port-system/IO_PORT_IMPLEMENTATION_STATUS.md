...
| `npm run test:unit`                    | Pass — 72/72    | Auth/product/location, conversations/Orbit feed/attention controls, packaged OpenCode capability/SSE/tasks/diffs/tools/fork/abort/revert/permissions, gateway protocols/adapters/routing and fixed email templates are covered. |
