...
| Gateway                    | `io-gateway` v23 Released with a shared idempotent reserve/settle/circuit/receipt core, workspace region policy, per-key spend enforcement and versioned 5.5% fee settlement; JWT-protected, traffic disabled.        |
