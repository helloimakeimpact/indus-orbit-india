...
| ------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Unified OpenAI-compatible public API        | Partial internal normalization only                                 | Add a versioned external `/v1` contract, streaming/SSE, errors, idempotency, API keys, rate limits, SDK examples and compatibility tests.                                            |
