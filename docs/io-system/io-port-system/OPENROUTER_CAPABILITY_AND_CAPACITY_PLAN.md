...
| Workspaces, virtual keys and limits         | Partial: projects/environments, one-time hash-only keys, scopes, 30-day default/90-day maximum expiry, revocation, minute/day/month request limits and day/month spend caps exist | Add operator suspension/anomaly policy, rotation reminders, richer per-key analytics and production key classes after hosted release/verification.                                   |
