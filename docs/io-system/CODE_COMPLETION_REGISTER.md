...
| Engineering quality and CI            | Partial  | Member unit suite passes 57/57 and the full database suite passes 700/700; admin passes 16/16. API/commercial and admin Trust contracts are synchronized and regression tested.                                                                                                                                                                                                                                                                                  | Require all checks in both repositories and add component/Playwright/accessibility/visual/load/soak coverage plus bundle budgets.                                                                                                                      |
