...
| Supabase platform/data integrity      | Partial  | Hosted project `jpwvgpnbkrktipwhvqss` has 76 migrations, `io-gateway` v24, `io-openai` v4 and `io-provider-conformance` v1. Block-aware DM Broadcast and member-authorized terminal metadata Broadcast are exact private policies; key/residency/conformance and FK-index migrations are verified. A clean local replay passes 76 migrations and 681 assertions.                                                                                                 | Automate generated-type drift, retain alias-safe deployment, run hosted personas/contracts and establish staging/backup/restore.                                                                                                                       |
| Engineering quality and CI            | Partial  | Member unit suite passes 57/57 and the full database suite passes 681/681; admin passes 13/13. API/commercial contract drift discovered by the full replay was repaired.                                                                                                                                                                                                                                                                                         | Run final format/lint/type/build for this release, require all checks in both repositories and add component/Playwright/accessibility/visual/load/soak coverage plus bundle budgets.                                                                   |
...
- The current clean local baseline is 76 migrations and 681 assertions, including the API/commercial, private-conversation and terminal private-Broadcast contracts.
