...
| Data and Supabase                     | Partial | Project `jpwvgpnbkrktipwhvqss` is healthy in `ap-south-1` with 114 hosted migrations; latest hardens concurrent timeout replay. Member privacy requests and Space timeouts/remove/restore/spam controls are active. Actual export generation/deletion remain unavailable until data-inventory and retention approval. `io-gateway` v28, `io-openai` v10, conformance v3, scanner worker v1 and health probe v1 remain active. The structured-Spaces migration remains unapplied pending explicit approval.                                                                                                                                                   |
| Quality and release operations        | Partial | The current focused suites pass 102/102 member and 32/32 admin tests; the new hosted member-safety contract adds 15 structural assertions. Formatting, typecheck, zero-warning lint, production builds and enforced bundle budgets are rerun at every release commit. Authenticated personas, accessibility/visual/real-daemon/load evidence, field Core Web Vitals, telemetry and incident-response drills remain.                                                                                                                                                                                                                                          |
