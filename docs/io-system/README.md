...
| Conversations                         | Partial | Durable direct messages, caller-bound keyset history and the Chapter/Mission Space foundation are Released. The collaboration slice now includes Threads/replies, reactions, reports, quarantined attachments, moderation, Room preferences/pins, personal bookmarks and Thread follow/read/unread. Search, Boards, scanner activation, shared shell primitives and authenticated personas remain.                                                                                                                                                           |
