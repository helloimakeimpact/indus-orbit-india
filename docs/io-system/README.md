...
| Conversations                         | Partial | Durable direct messages and the Chapter/Mission Space foundation are Released. The collaboration slice includes paged Room/Thread feeds and search, public/private Threads, reactions, reports, quarantined attachments, moderation, Room permissions/slow mode/preferences/pins, bookmarks, mentions and Thread follow/read/unread. Replay-safe in-tab Room/Thread/attachment retry is Verified locally. Boards, scanner activation, cross-surface reconnect, shared shell primitives and authenticated personas remain.                                    |
