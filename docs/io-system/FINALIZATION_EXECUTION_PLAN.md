...
6. **Released/Verified typing and privacy-request slice:** active-conversation typing is exact-pair, opt-out, expiring and non-durable. Saved-item aggregation is locally Verified. Account export/deletion request intake and bounded admin review are Released; service-only artifact/purge workers remain policy-blocked. Stronger member timeout/remove/spam controls remain.
