...
| Mentions                        | Partial: explicit person selection, user/private-Thread authorization, ten-person fan-out, mute/digest/quiet scheduling, fixed notification and content-free outbox are Released          | Add bounded role mentions, worker delivery evidence, abuse analytics and authenticated multi-persona tests.                                                                    |
