...
| Boards/forums                   | Loops/S.O.D.A./stories are separate content types             | Add structured topic templates, tags, sorting, accepted outcome and moderation only where discussion needs long-lived discoverability; link rather than copy existing content.           |
