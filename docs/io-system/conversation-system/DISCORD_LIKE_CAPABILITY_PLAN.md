...
| Rooms/channels/categories       | Released blueprints/access plus manager name/description/posting controls and override RPC                                                                                                | Add create/reorder/archive and full role editor UI, slow mode and view-as-role tests.                                                                                          |
...
| Mentions                        | Partial: explicit person selection, user/private-Thread authorization, ten-person fan-out, mute/digest preference handling, fixed notification and content-free outbox are Released       | Add bounded role mentions, quiet-hour scheduling, worker delivery evidence, abuse analytics and authenticated multi-persona tests.                                             |
...
| Notifications                   | Partial: Room preference UI/RPC, Thread follow/read/unread, person-mention notification/digest intent and private outbox foundations exist                                                | Project more Space events, add role hierarchy, scheduled digests, quiet hours, retries/dead-letter operations and deploy the fixed-template worker.                            |
