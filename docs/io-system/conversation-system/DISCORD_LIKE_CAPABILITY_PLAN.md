...
| Notifications                   | Partial: Room preference UI/RPC, Thread follow/read/unread and private outbox foundations exist                                                                                           | Project Space events, add role/mention hierarchy, digests, quiet hours, retries/dead-letter operations and deploy the fixed-template worker.                                   |
