...
| Threads                         | Partial: Room-linked timelines, replies/counts and moderated lock/reopen are Released         | Add follow/unfollow, membership, archive, unread/notification UI and private-thread permission personas.                                                                       |
...
| Moderation and safety           | Partial: member report UI plus reasoned/audited content restrict/restore and Thread lock      | Add admin triage/assignment, block/mute/timeout/remove, slow mode, spam controls, appeal and retention policy.                                                                 |
