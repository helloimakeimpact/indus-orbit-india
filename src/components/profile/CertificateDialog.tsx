  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="gap-2 border-[var(--saffron)] text-[var(--saffron)] hover:bg-[var(--saffron)]/10"
        >
        ...
        <div className="w-full overflow-x-auto pb-4 text-center">
          ...
          >
            ...
            <div
              ...
              style={{ color: bgTheme === "dark" ? "#ffffff" : "#000000" }}
            >
              <Orbit className="h-96 w-96" />
            </div>
            <div
              className="absolute -left-20 -bottom-20 opacity-5 pointer-events-none"
              style={{ color: bgTheme === "dark" ? "#ffffff" : "#000000" }}
            >
              <Orbit className="h-96 w-96" />
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center rounded-2xl p-8">
              ...
              <p
                ...
                style={{
                  color: bgTheme === "dark" ? "rgba(252,250,245,0.8)" : "rgba(14,10,31,0.8)",
                }}
              >
              ...
              <p
                className="text-xl font-light italic mb-10 max-w-lg"
                style={{
                  color: bgTheme === "dark" ? "rgba(252,250,245,0.9)" : "rgba(14,10,31,0.9)",
                }}
              >
                is recognized as a Verified{" "}
                {data?.segment ? SEGMENT_META[data.segment].label : "Member"} within the Indus Orbit
                ecosystem, actively contributing to India's intelligence layer.
              </p>

              {/* Metrics */}
              {!loading && data && (
                <div
                  className="flex gap-10 pt-8 mb-8 w-full justify-center"
                  style={{
                    borderTop:
                      bgTheme === "dark"
                        ? "1px solid rgba(255,255,255,0.2)"
                ...
                >
                  {data.isLead && (
                    <div className="flex flex-col items-center">
                      ...
                      <span
                        ...
                        style={{
                          color:
                            bgTheme === "dark" ? "rgba(252,250,245,0.6)" : "rgba(14,10,31,0.6)",
                        }}
                      >
                        Status
                      </span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span
                      className="text-xs uppercase tracking-wider mt-1"
                      style={{
                        color: bgTheme === "dark" ? "rgba(252,250,245,0.6)" : "rgba(14,10,31,0.6)",
                      }}
                    >
                      Chapters
                    </span>
              ...
              {/* Vision / Mission */}
              <div
                className="mt-6 rounded-2xl p-6 w-full max-w-xl"
                style={{
                  backgroundColor:
                    bgTheme === "dark" ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.03)",
                  border:
                    bgTheme === "dark"
              ...
              >
                ...
                >
                  <strong style={{ color: bgTheme === "dark" ? "#fcfaf5" : "#0e0a1f" }}>
                    The Indus Orbit Mission:
                  </strong>{" "}
                  Building the digital and physical gravity that pulls India’s next generation of
                  builders into the same orbit. Connection. Synergy. Society.
                </p>
              </div>

              <div
                className="mt-12 flex w-full justify-between items-end pt-6 px-4"
                style={{
                  borderTop:
                    bgTheme === "dark"
                      ? "1px solid rgba(255,255,255,0.2)"
              ...
              >
                <div className="flex items-center gap-4 text-left">
                  ...
                  <div>
                    <p
                      ...
                      style={{ color: bgTheme === "dark" ? "#fcfaf5" : "#0e0a1f" }}
                    >
                      Indus Orbit Trust Layer
                    </p>
                    <p
                      className="text-xs uppercase tracking-widest mt-1"
                      style={{
                        color: bgTheme === "dark" ? "rgba(252,250,245,0.7)" : "rgba(14,10,31,0.7)",
                      }}
                    >
                      Scan to verify or join
                    </p>
                  </div>
                </div>
                <div className="text-right">
                  <p
                    ...
                    style={{ color: "#f97316", textShadow: "0 1px 2px rgba(0,0,0,0.1)" }}
                  >
                    ID: {userId.split("-")[0].toUpperCase()}
                  </p>
                  <p
