        ...
        <>
          ...
          <Field label="What do you want to build?">
            <Input
              ...
              placeholder="e.g. AI agents, design, research…"
            />
          </Field>
        ...
        <>
          ...
          <Field label="Sector">
            <Input
              ...
              placeholder="e.g. fintech, agri, health"
            />
          </Field>
          <Field label="What are you looking for?">
            <Input
              value={get("looking_for")}
              onChange={(e) => set("looking_for", e.target.value)}
              placeholder="mentors, hires, capital, distribution"
            />
          </Field>
        ...
        <>
          ...
          <Field label="Industries">
            <Input
              ...
              placeholder="BFSI, manufacturing, retail, health, tech…"
            />
          </Field>
        ...
        <>
          ...
          <Field label="Typical ticket size">
            <Input
              ...
              placeholder="e.g. ₹25L–₹2Cr or $100k–$1M"
            />
          </Field>
          <Field label="Stages">
            <Input
        ...
        <>
          ...
          <Field label="How would you like to contribute?">
            <Input
              ...
              placeholder="mentorship, capital, hiring, advocacy, giving"
            />
          </Field>
          <Field label="Connection to India">
            <Textarea
              ...
              placeholder="Hometown, family roots, why this matters to you"
            />
          </Field>
        </>
      );
        ...
        <>
          <Field label="Affiliation">
            <Input
              ...
              placeholder="Lab, university, institute"
            />
          </Field>
          <Field label="Field">
            <Input
              ...
              placeholder="e.g. NLP, policy, education research"
            />
          </Field>
