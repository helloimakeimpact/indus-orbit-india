...
import { Home, Users, User as UserIcon, Shield, UserCog, LogOut, Menu, X, Megaphone, LayoutDashboard, ClipboardList, Flag, ScrollText, ShieldCheck, KeyRound, CalendarClock, TrendingUp, Globe2, BookOpen, MapPin, CalendarDays, Compass, Target, Sparkles, FileCheck, GraduationCap, Lightbulb } from "lucide-react";
