...
export const Route = createFileRoute("/members")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Meet the founders, experts, investors and diaspora in the Indus Orbit network.",
      },
      ...
      <section className="px-6 pt-32 pb-12">
        <div className="mx-auto w-full max-w-7xl">
            ...
            <div className="mt-12 mb-8">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {spotlights.map((s) => (
                  <div
                    key={s.id}
                    className="rounded-3xl border-2 border-[var(--saffron)]/30 bg-card p-6 relative overflow-hidden group hover:border-[var(--saffron)]/60 transition shadow-sm"
                  >
          ...
          {loading ? (
            ...
            <p className="mt-12 text-destructive">Could not load members: {error}</p>
          ) : members.length === 0 ? (
