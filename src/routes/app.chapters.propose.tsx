  ...
  return (
    <div className="mx-auto w-full max-w-4xl py-8">
      ...
      <p className="text-muted-foreground mb-8">
        Step up to lead an Indus Orbit chapter by base city, country, or region. Exact venue
        addresses can be added later on individual events.
      </p>

      <form
        onSubmit={handleSubmit}
        className="space-y-6 bg-card p-8 rounded-3xl border border-border"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              name="proposedName"
              required
              placeholder="e.g. San Francisco Founders"
          ...
          <div className="space-y-2">
            ...
            <Input
              id="targetAudience"
              name="targetAudience"
              placeholder="e.g. AI Startups, Biotech Researchers"
        ...
        <p className="rounded-2xl bg-muted/40 p-3 text-xs leading-5 text-muted-foreground">
          Chapter proposals store a public base location only. Use event submissions for venue
          names, street addresses, or online rooms.
        </p>
        ...
        <div className="pt-4 flex justify-end gap-4">
          <Button variant="outline" type="button" onClick={() => navigate({ to: "/app/chapters" })}>
            Cancel
          </Button>
          <Button
            type="submit"
            className="bg-[var(--indigo-night)] text-[var(--parchment)]"
            disabled={busy}
          >
