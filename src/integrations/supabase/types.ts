  ...
  public: {
    Tables: {
      account_privacy_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "account_privacy_requests_assigned_to_fkey"
            columns: ["assigned_to"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "account_privacy_requests_requester_id_fkey"
    ...
    Functions: {
      ...
      admin_io_endpoint_incident_queue: {
        Args: { _limit?: number }
        Returns: {
          circuit_state: string
          endpoint_id: string
      ...
      admin_list_root_change_requests: {
        Args: { _status?: string }
        Returns: Json
      }
      ...
      admin_notification_delivery_queue: {
        Args: { _limit?: number; _status?: string }
        Returns: Json
      }
      ...
      admin_review_account_privacy_request: {
        Args: {
          _expected_version: number
          _next_state: string
      ...
      admin_set_notification_delivery_state: {
        Args: {
          _action: string
          _expected_status: string
          _id: string
      ...
      cancel_my_account_privacy_request: {
        Args: { _expected_version: number; _request_id: string }
        Returns: Json
      }
      claim_conversation_attachment_scan_batch: {
        Args: { _limit?: number }
        Returns: {
          attempt_count: number
          byte_size: number
      ...
      complete_conversation_attachment_scan_attempt: {
        Args: {
          _attachment_id: string
          _error_code?: string
          _lease_token: string
      ...
      io_get_probeable_endpoint_connections: {
        Args: never
        Returns: {
          auto_route_tier: string
      ...
      request_my_account_privacy_action: {
        Args: {
          _client_request_id: string
          _confirmation_text: string
          _member_note: string
      ...
      set_managed_conversation_member_timeout: {
        Args: {
          ...
          _expected_membership_version: number
          _reason: string
          _space_id: string
          _target_user_id: string
        }
      ...
      set_managed_conversation_member_timeout_serialized: {
        Args: {
          _client_request_id: string
          _duration_seconds: number
          _expected_membership_version: number
